...
RSpec.describe "Activities", type: :request do
  ...
  # it "should archive activity on destroy" do
  #   expect {
  ...
  it "activities/show.html.erb renders strict schedule activity with full details" do
    activity = @user.activities.create!(
  ...
  it "activities/show.html.erb renders flexible activity" do
    activity = @user.activities.create!(
      name: "Reading",
  ...
  it "activities/show.html.erb renders deadline activity" do
    activity = @user.activities.create!(
      name: "Tax Filing",
  ...
  it "activities/show.html.erb renders expired deadline activity" do
  ...
  it "activities/show.html.erb renders activity without description" do
    activity = @user.activities.create!(
      name: "Simple Task",
      schedule_type: "flexible",
      max_frequency_days: nil
  ...
  it "activities/show.html.erb renders strict activity with conditional times" do
  ...
  it "activities/show.html.erb handles template conditionals" do
  ...
  it "activities/show.html.erb renders with multiple links" do
    activity = @user.activities.create!(
  ...
  it "activities/show.html.erb renders yearly frequency" do
    activity = @user.activities.create!(
